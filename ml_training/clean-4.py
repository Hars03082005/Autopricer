...
INPUT_FILES = {
    "pincode without owner-4": DATA_DIR / "pincode without owner-4.csv",
}
...
def clean_and_validate(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for col in ["locality_density", "popularity_score", "price_per_year"]:
...
ML_FEATURES = [
    ...
    "odometer_reading",
    "km_per_year",
    "owner_count",      # added: needed for ownership_trust_score signal

    # Derived features
    "brand_tier",
    "age_km_interaction",
    "ownership_trust_score",  # added: 0-100 scale matching training
